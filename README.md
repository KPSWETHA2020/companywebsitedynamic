...
<head>
    <title> Premium Industries Limited </title>
    <link rel="stylesheet" href="{% static 'css/layout.css' %}">
    <link rel = "icon" href ="{% static 'img/data.jpg' %}" type = "image/x-icon"> 
...
<body>
    ...
    <div class="footer">
        Copyright © 2021 Premium Industries Limited, Developed by SWETHA.K.P
    </div>
    </div>
</body>
...
{% block content %}
    ...
    <h1>About Us</h1>
    <img src="/static/img/buliding.jpg" alt="Buliding">
